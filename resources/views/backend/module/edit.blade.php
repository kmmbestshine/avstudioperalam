                        ...
                        <div class="x_content">
                            <form action="{{route('module.update',$module->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter name" value="{{$module->name}}">
                                    <span class="error"><b>
                                         @if($errors->has('name'))
                                                {{$errors->first('name')}}
                                            @endif</b>
                               ...
                               {{-- <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="module_key" name="module_key" placeholder="Enter module_key" value="{{$module->module_key}}">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="module_url" name="module_url" value="{{$module->module_url}}" placeholder="Enter module_url" >
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="module_icon" name="module_icon" value="{{$module->module_icon}}" placeholder="Enter module_icon (eg:- fa fa-dashboard)" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Module Display To Roles For &nbsp;</label>
                                ...
                                <div class="form-group">
                                    <label>Module Not Display To Roles For &nbsp;</label>
