            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{url('studio-update-delivery',$update->customer_id)}}" method="get">
                               
                               
                                <div class="form-group">
                                    <label>Status</label>
                                    <input type="radio" name="status" value="1" id="Active" checked=""><label for="Active"> Deliverd</label>
                                    <input type="radio" name="status" id="deactive" value="0"><label for="deactive">Undeliverd</label>
