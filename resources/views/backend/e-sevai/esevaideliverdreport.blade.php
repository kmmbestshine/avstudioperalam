...
@section('content')
    <div class="right_col" role="main">
        <div class="">
            ...
            <br>
            <div class="row">
                            <form action="{{route('esevai.deliverd.reportlist')}}" method="post">
                                {{csrf_field()}}
                                <div class="col-md-3">
