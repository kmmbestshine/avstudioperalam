        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{route('esevaibill.store')}}" method="post">
                                {{ csrf_field()}}
                                <div class="row">
                              <div class="col-md-6">
          ...
          <table  id="myTable" style="border: 1px solid black"  class="table table-striped table-bordered table-hover">                      
            ...
            <tbody>
              ...
              <?php $j=1; ?>
                <?php for($i = 0; $i < count($service_id); $i++) : ?>
                <tr>
                    ...
                    <td width="20%"><b>{{$service_name[$i]}}</b><input type="hidden" value="{{$service_name[$i]}}" name="service_name[]"><br></td>  
                    <td width="50%"><b>{{$units[$i]}}</b><input type="hidden" value="{{$units[$i]}}" name="units[]"><br></td> 
                    <td width="50%"><b> {{$qty[$i]}}</b><input type="hidden" value="{{$qty[$i]}}" name="qty[]"><br></td> 
                    <td width="50%"><b> {{$rate[$i]}}</b><input type="hidden" value="{{$rate[$i]}}" name="rate[]"><br></td> 
                    <td width="50%"><b> Rs : {{$qty[$i] * $rate[$i]}}</b><input type="hidden" value="{{$amt[$i]}}" name="amt[]"><br></td> 
                    
                    <input type="hidden" value="{{$service_id[$i]}}" name="eservice_id[]">

                    
                    </tr>
                    <input type="hidden" value="{{$i+1}}" name="total_service">
                  <?php endfor ?>
                                            <tr>
                                                <th colspan="5"></th>
