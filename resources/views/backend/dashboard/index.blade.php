...
@section('content')
    <div class="right_col" role="main">
        <!-- top tiles -->
        <div align="left" style="font-size: x-large;"><label for="product_id">Studio</label></div>
        <div class ="row">
        <div class="row tile_count" style="font-size: x-large;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box brown-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    ...
                    <div class="count">{{$tot_revenue}}</div>
                    <div class="title">Total Revenue</div>
                </div><!--/.info-box-->
            </div><!--/.col-->

            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box dark-bg bg-green" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-thumbs-o-up"></i>
                    <div class="count">{{$tot_paid}}</div>
        ...
        <div align="left" style="font-size: x-large;"><label for="product_id">E-Sevai</label></div>
        <div class ="row">
             <div class="row tile_count" style="font-size: x-large;">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box blue-bg bg-red" style="text-align: center;border-radius: 5px;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box brown-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-shopping-cart"></i>
                    <div class="count">{{$tot_revenue1}}</div>
                    <div class="title">Total Revenue</div>
                </div><!--/.info-box-->
            </div><!--/.col-->
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box dark-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-product-hunt"></i>
                    <div class="count">{{$totalcustomer1}}</div>
                    <div class="title">Total Customer</div>
                </div><!--/.info-box-->
            </div><!--/.col-->
        </div>
<div align="left" style="font-size: x-large;"><label for="product_id"> Online Payment</label></div>
         <div class ="row">
        
             <div class="row tile_count" style="font-size: x-large;">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box blue-bg bg-orange" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-money"></i>
                    <div class="count">
                        {{$tot_available}}
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box brown-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-shopping-cart"></i>
                    <div class="count">{{$tot_transfer}}</div>
                    <div class="title">Total Transfer</div>
                </div><!--/.info-box-->
            </div><!--/.col-->

            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box dark-bg bg-orange" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-thumbs-o-up"></i>
                    <div class="count">{{$tot_comission}}</div>
                    <div class="title">Total Comission</div>
                </div><!--/.info-box-->
            </div><!--/.col-->
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box dark-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    <i class="fa fa-product-hunt"></i>
                    <div class="count">{{$totalcustomer2}}</div>
                    <div class="title">Total Customer</div>
                </div><!--/.info-box-->
            </div><!--/.col-->
        </div>
