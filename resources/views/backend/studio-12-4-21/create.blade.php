                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group top_search">
                        <div class="row">
                            <div class="text-right">
                                ...
                                <a href="{{route('studio.view.customer')}}" class="btn btn-success">All Orders List</a>
                                <a href="{{route('studio.order.undeliverd')}}" class="btn btn-success">Undeliverd List</a>
                                <a href="{{route('studio.order.proof')}}" class="btn btn-success">Proof List</a>
                                <a href="{{route('studio.order.deliverd')}}" class="btn btn-success">Deliverd List</a>
                            </div>
                        </div>
                    </div>
                </div>
