            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{route('studiopayment.store')}}" method="post">
                                {{ csrf_field()}}
                                <div class="row">
                              <div class="col-md-6">
            ...
            <tbody>
              ...
              <?php $j=1; ?>
                ...
                <tr>
                    ...
                    <td width="20%"><b>{{$sizes[$i]}}</b><input type="hidden" value="{{$sizes[$i]}}" name="sizes[]">
                        <input type="hidden" value="{{$unpaid_ids[$i]}}" name="unpaid_ids[]"><br></td>  
