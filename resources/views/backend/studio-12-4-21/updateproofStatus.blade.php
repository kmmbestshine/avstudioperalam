            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{route('studio.proof.status')}}" method="post">
                                {{ csrf_field()}}
                               
                                <div class="form-group">
                                    <label>Status</label>
                                    <input type="radio" name="status" value="1" id="Active" checked=""><label for="Active"> Proof Ready</label>
                                    <input type="radio" name="status" id="deactive" value="0"><label for="deactive">Not Yet</label>
                                    <input type="hidden" name="service_id" id="deactive" value="{{$update->service_id}}">
                                </div>
                                <!-- /.box-body -->
