...
@section('content')
    <div class="right_col" role="main">
        <div class="">
            ...
            <br>
            <div class="row">
                            <form action="{{route('get.order.proof')}}" method="post">
                                {{csrf_field()}}
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <button name="" class="btn btn-info">All Proof Order</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <table style="border: 1px solid black" class="table table-striped table-bordered table-hover" id="categorytable">
                               ...
                               @foreach($allproof as $pc)
                                    <tr>
                                        ...
                                        <td>
                                            @if($pc->proof_status == 0)
                                                <span class="label label-danger"> Not Yet </span>
                                            @else
                                                <span class="label label-success"> Proof Ready </span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
