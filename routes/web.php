...
Route::get('/companies/edit/{id}', ['as' => 'company.edit', 'uses' => 'backend\CompanyController@edit']);
Route::post('/companies/update/{id}', ['as' => 'companies.update', 'uses' => 'backend\CompanyController@update']);
...
Route::group(['middleware' => 'Revalidate'],function() {
    Route::group(['middleware' => 'Authenticate'], function () {
        Route::get('/companies-edits', ['as' => 'company.edits', 'uses' => 'backend\DashboardController@companyedit']);
        Route::post('/companiess-updates', ['as' => 'companiess.update', 'uses' => 'backend\DashboardController@updates']);

        Route::get('/dashboard-panel', ['as' => 'user.dashboard', 'uses' => 'backend\DashboardController@index']);
        Route::get('/cust-dashboard-panel', ['as' => 'customer.dashboard', 'uses' => 'backend\DashboardController@customerindex']);
...
Route::post('/workorder-updatestatus', ['as' => 'workorder.update.task.status', 'uses' => 'backend\ServiceorderController@order_update_status']);
        ...
        Route::get('/esevai-report', ['as' => 'esevai.report', 'uses' => 'backend\EsevaiController@eSevaireport']);
        Route::get('/esevai-allreport', ['as' => 'esevai.service.allreport', 'uses' => 'backend\EsevaiController@eSevaiallreport']);
        Route::post('/esevai-report.all', ['as' => 'esevai.all.reportlist', 'uses' => 'backend\EsevaiController@geteSevaiallreport']);
        Route::get('/esevai-normalreport', ['as' => 'esevai.service.normalreport', 'uses' => 'backend\EsevaiController@eSevainormalreport']);
        Route::post('/esevai-report-normal', ['as' => 'esevai.normal.reportlist', 'uses' => 'backend\EsevaiController@geteSevainormalreport']);
        Route::get('/esevai-undeliverdreport', ['as' => 'esevai.service.undeliverdreport', 'uses' => 'backend\EsevaiController@eSevaiundeliverdreport']);
        Route::post('/esevai-report-undeliverd', ['as' => 'esevai.undeliverd.reportlist', 'uses' => 'backend\EsevaiController@geteSevaiundeliverdreport']);
        Route::get('/esevai-deliverdreport', ['as' => 'esevai.service.deliverdreport', 'uses' => 'backend\EsevaiController@eSevaideliverdreport']);
        Route::post('/esevai-report-deliverd', ['as' => 'esevai.deliverd.reportlist', 'uses' => 'backend\EsevaiController@geteSevaideliverdreport']);
        Route::get('/update-esevai-undeliverd/{id}', ['as' => 'update.esevai.undeliverd', 'uses' => 'backend\EsevaiController@updateesevaistatus']);

        Route::get('/deposit-account', ['as' => 'online.deposit.account', 'uses' => 'backend\TransactionController@createdepositaccount']);
        Route::post('/deposit-amount-store', ['as' => 'deposit.amount.store', 'uses' => 'backend\TransactionController@depositamountstore']);
        Route::get('/deposit-amount-list', ['as' => 'deposit.amount.list', 'uses' => 'backend\TransactionController@viewdepositamount']);
        Route::get('/deposit-update/{id}/edit', ['as' => 'deposit.amount.edit', 'uses' => 'backend\TransactionController@depositupdate']);
        Route::post('/deposit-update-amount/{id}', ['as' => 'deposit.amount.update', 'uses' => 'backend\TransactionController@postdepositupdate']);
        Route::get('/create-fundtransfer', ['as' => 'online.fund.transfer', 'uses' => 'backend\TransactionController@createfundtransfer']);
        Route::post('/fundtransfer-amt-verify', ['as' => 'fundtransfer.amt.verify', 'uses' => 'backend\TransactionController@fundtransferamountverify']);
        Route::post('/fundtransfer-amt-store', ['as' => 'fundtransfer.amt.store', 'uses' => 'backend\TransactionController@fundtransferamountstore']);
        Route::get('/fundtransfer-amount-list', ['as' => 'fundtransfer.amount.list', 'uses' => 'backend\TransactionController@viewfundtransferamount']);
        ...
        Route::get('/studio-view-customer', ['as' => 'studio.view.customer', 'uses' => 'backend\StudioController@viewAllcustomer']);
        Route::post('/studiopayment-store', ['as' => 'studiopayment.store', 'uses' => 'backend\StudioController@studiopaymentstore']);
        Route::post('/studioCustomers', ['as' => 'custom.view.all', 'uses' => 'backend\StudioController@studioallCustomers']);
        Route::get('/studio-order-undeliverd', ['as' => 'studio.order.undeliverd', 'uses' => 'backend\StudioController@viewAllundeliverd']);
        Route::post('/studio-get-undeliverd', ['as' => 'get.order.undeliverd', 'uses' => 'backend\StudioController@studioallUndeliverd']);
        Route::get('/update-order-undeliverd/{id}', ['as' => 'update.order.undeliverd', 'uses' => 'backend\StudioController@updateOrderstatus']);
        Route::get('/studio-update-delivery/{id}', ['as' => 'studio.delivery.status', 'uses' => 'backend\StudioController@studioUpdateDeliverystatus']);
        Route::post('/studiobill-store-exist', ['as' => 'studiobill.store.exist', 'uses' => 'backend\StudioController@studiobillstoreexist']);
        Route::post('/studiobill-exist-verify', ['as' => 'studiobill.verify.exist', 'uses' => 'backend\StudioController@studiobillverifyexist']);
        Route::get('/upload-order-photos/{id}', ['as' => 'upload.order.photos', 'uses' => 'backend\StudioController@UploadOrderphotos']);
        Route::post('/upload-cust-photos', ['as' => 'image.upload.post', 'uses' => 'backend\StudioController@postUploadOrderphotos']);
        Route::get('/studio-order-deliverd', ['as' => 'studio.order.deliverd', 'uses' => 'backend\StudioController@viewAlldeliverd']);
        Route::post('/studio-get-deliverd', ['as' => 'get.order.deliverd', 'uses' => 'backend\StudioController@studioalldeliverd']);
        Route::get('/update-order-proof/{id}', ['as' => 'update.order.proof', 'uses' => 'backend\StudioController@updateproofOrderstatus']);
        Route::get('/studio-update-proof/{id}', ['as' => 'studio.proof.status', 'uses' => 'backend\StudioController@studioUpdateProofstatus']);
        Route::post('/studio-get-proof', ['as' => 'get.order.proof', 'uses' => 'backend\StudioController@studioallproof']);
        Route::get('/studio-order-proof', ['as' => 'studio.order.proof', 'uses' => 'backend\StudioController@viewAllproof']);
        Route::get('/studio-order-payment', ['as' => 'studio.order.payment', 'uses' => 'backend\StudioController@studiopayment']);
        Route::post('/studio-post-payment', ['as' => 'studio.post.payment', 'uses' => 'backend\StudioController@poststudiopayment']);
        Route::post('/studio-collection-verify', ['as' => 'studio.collection.verify', 'uses' => 'backend\StudioController@studiopaymentverify']);
